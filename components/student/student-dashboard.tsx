        ...
        <header className="rounded-[2rem] border border-white/90 bg-white/85 p-5 shadow-[var(--shadow-card)] backdrop-blur sm:p-6">
          <div className="flex items-center justify-between gap-4">
            ...
            <Link
              ...
              href="/profile"
            >
              <CharacterAvatar avatar={profile.avatar} className="size-full rounded-[1.25rem] transition group-hover:scale-[1.03]" label={`${profile.username}'s avatar`} motion="expressive" />
            </Link>
          </div>
        </header>
